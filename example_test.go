...
func ExampleGcpHandler_Handle_withK8sPodinfo() {
...
func ExampleGcpHandler_Handle_withOpentelemetryBaggage() {
...
func ExampleGcpHandler_Handle_withOpentelemetryTrace() {
